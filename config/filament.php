...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Filament Email Domain
    |--------------------------------------------------------------------------
    |
    | You may change the domain of email addresses that can access the admin.
    |
    */

    'email_domain' => env('FILAMENT_EMAIL_DOMAIN'),
    ...
    */
    ...
    'auth' => [
        ...
        'pages' => [
            'login' => function () { return view('auth.login'); },
        ],
    ],
